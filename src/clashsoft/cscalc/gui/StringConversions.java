...
public class StringConversions extends DefaultMutableTreeNode
{
	...
	public StringConversions(Object userObject)
	{
		...
		node_1.add(new DefaultMutableTreeNode(new StringConverterReplaceCharacters()));
		node_1.add(new DefaultMutableTreeNode(new StringConverterRemoveChars()));
		node_1.add(new DefaultMutableTreeNode(new StringConverterRetainCharacters()));
		node_1.add(new DefaultMutableTreeNode(new StringConverterTrim()));
		node_1.add(new DefaultMutableTreeNode(new StringConverterRemoveVowels()));
		node_1.add(new DefaultMutableTreeNode(new StringConverterRemoveSpecial()));
		add(node_1);
		node_1 = new DefaultMutableTreeNode("Character Positions & Ranges");
		node_1.add(new DefaultMutableTreeNode(new StringConverterRemoveCharsBeginning()));
		node_1.add(new DefaultMutableTreeNode(new StringConverterRemoveCharsEnd()));
